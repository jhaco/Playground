...
public class ShadowCreatureEntity extends HostileEntity {
    protected static final EntityAttribute SPAWN_REINFORCEMENTS = (new ClampedEntityAttribute((EntityAttribute)null, "shadow_creature.spawnReinforcements", 0.0D, 0.0D, 1.0D)).setName("Spawn Reinforcements Chance");
    ...
    public ShadowCreatureEntity(EntityType<? extends HostileEntity> type, World world) {
        super(type, world);
    ...
    protected void initAttributes() {
        ...
        this.getAttributes().register(SPAWN_REINFORCEMENTS).setBaseValue(this.random.nextDouble() * 0.10D);
        this.isFireImmune();
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1, new ShadowCreatureEntity.ChasePlayerGoal(this));
        this.goalSelector.add(2, new MeleeAttackGoal(this, 1.0D, false));
        this.goalSelector.add(7, new WanderAroundFarGoal(this, 1.0D, 0.0F));
        this.goalSelector.add(8, new LookAtEntityGoal(this, PlayerEntity.class, 8.0F));
        this.goalSelector.add(8, new LookAroundGoal(this));
        this.targetSelector.add(1, new ShadowCreatureEntity.TargetPlayerGoal(this));
    ...
    static class ChasePlayerGoal extends Goal {
        private final ShadowCreatureEntity shadow;
        private LivingEntity entity;
  
        public ChasePlayerGoal(ShadowCreatureEntity shadow) {
           this.shadow = shadow;
    ...
    static class TargetPlayerGoal extends FollowTargetGoal<PlayerEntity> {
        ...
        public TargetPlayerGoal(ShadowCreatureEntity shadow) {
